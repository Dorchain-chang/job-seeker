...
CSS = r"""
:root{
  --bg:#fafafa; --card:#ffffff; --line:#ebebeb; --txt:#171717; --sub:#666666;
  --pri:#0070f3; --pri2:#0068d6; --pri-soft:#ebf5ff;
  --pri-rgb:0,112,243; --pri2-rgb:0,104,214;
  --red:#c50000; --red-soft:#f7d4d6; --red-line:#f2c1c3;
  --orange:#ab570a; --orange-soft:#ffefcf; --orange-line:#f2ddb5;
  --green:#1a7f37; --green-soft:#e6f4ea;
  --grad:#171717;
  --grad-blue:#0070f3; --grad-red:#c50000; --grad-amber:#b45309; --grad-green:#1a7f37;
  --mono:ui-monospace,SFMono-Regular,Menlo,Consolas,"Courier New",monospace;
  --radius:8px;
  --shadow:0 1px 2px rgba(0,0,0,.04);
  --shadow-hi:0 1px 2px rgba(0,0,0,.05),0 4px 14px rgba(0,0,0,.07);
}
...
nav.tabbar a.logo .lm{width:28px;height:28px;border-radius:8px;background:var(--grad);display:flex;align-items:center;justify-content:center;flex:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.22),0 1px 3px rgba(0,0,0,.22);transition:transform .16s ease}
...
nav.tabbar .tab{flex:none;padding:7px 13px;border-radius:7px;font-size:13px;color:var(--sub);text-decoration:none;font-weight:500;white-space:nowrap;border:1px solid transparent;background:transparent;transition:background .15s,color .15s}
nav.tabbar .tab[aria-current="page"]{background:#f4f4f5;color:var(--txt);border-color:var(--line);box-shadow:none}
nav.tabbar .tab:not([aria-current]):hover{background:#f4f4f5;color:var(--txt)}
nav.tabbar .sync{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--sub);margin-left:auto;flex:none;background:#fff;border:1px solid var(--line);border-radius:999px;padding:4px 11px;white-space:nowrap;font-family:var(--mono)}
nav.tabbar .sync .dot{width:7px;height:7px;border-radius:50%;background:var(--green);box-shadow:0 0 0 3px rgba(26,127,55,.12)}
...
/* ---------- 主题色自定义 ---------- */
.themebtn{flex:none;width:34px;height:34px;border-radius:999px;border:1px solid var(--line);background:#fff;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0;margin-left:4px}
...
.themepop{position:fixed;top:60px;right:14px;z-index:80;background:#fff;border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow-hi);padding:14px;width:230px;display:none}
...
.themepop .sw{width:26px;height:26px;border-radius:50%;border:2px solid #fff;outline:1px solid var(--line);cursor:pointer;padding:0}
...
body.navside nav.tabbar .tab{text-align:left;border-radius:6px}
body.navside nav.tabbar .tab[aria-current="page"]{border-left:2px solid var(--txt);border-radius:0 6px 6px 0;padding-left:11px}
...
@media (max-width:900px){
  ...
  body.navside nav.tabbar .tab{border-radius:7px}
  body.navside nav.tabbar .tab[aria-current="page"]{border-left:1px solid transparent;border-radius:7px;padding-left:13px}
}
/* ---------- 侧栏分组（发现 / 我的 / 配置，navside 常驻） ---------- */
nav.tabbar .sngroup{flex:none;font-family:var(--mono);font-size:10.5px;font-weight:500;color:#8f8f8f;letter-spacing:2px;padding:12px 8px 3px;text-align:left}
nav.tabbar .sngroup:first-of-type{padding-top:16px}
@media (max-width:900px){nav.tabbar .sngroup{display:none}}
/* ---------- 求职助理 / 定时任务 / 日程安排 ---------- */
.agchat{display:flex;flex-direction:column;gap:8px;max-height:340px;overflow-y:auto;background:#fafbfe;border:1px solid var(--line);border-radius:12px;padding:12px;margin-bottom:10px}
.agmsg{max-width:86%;padding:9px 12px;border-radius:12px;font-size:13px;white-space:pre-wrap;word-break:break-word}
.agmsg.me{align-self:flex-end;background:var(--grad);color:#fff;border-bottom-right-radius:4px}
.agmsg.ai{align-self:flex-start;background:#fff;border:1px solid var(--line);border-bottom-left-radius:4px}
...
.taskrow{display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid var(--line);border-radius:12px;margin-bottom:8px;background:#fafbfe;flex-wrap:wrap;font-size:13px}
...
.schrow{display:flex;align-items:flex-start;gap:10px;padding:11px 12px;border:1px solid var(--line);border-radius:12px;margin-bottom:8px;background:#fafbfe;flex-wrap:wrap}
...
section>h2 svg{width:27px;height:27px;flex:none;background:#f4f4f5;border-radius:7px;padding:6px;stroke:var(--sub)}
section>h2 .cnt{margin-left:auto;font-family:var(--mono);font-size:11.5px;color:var(--sub);font-weight:500;background:#f4f4f5;border-radius:999px;padding:2px 9px}
#todayList{display:flex;flex-direction:column;gap:8px}
.titem{display:flex;align-items:center;gap:10px;padding:11px 13px;border-radius:8px;background:#fff;border:1px solid var(--line);flex-wrap:wrap;transition:border-color .15s,box-shadow .15s}
.titem:hover{border-color:#d4d4d4;box-shadow:none}
...
.titem.blue{background:var(--pri-soft);border-color:#c3e1fd}
.titem .badge{font-size:11px;font-weight:600;border-radius:6px;padding:3px 9px;flex:none;color:#fff;letter-spacing:.2px}
...
.tag{font-size:11px;font-weight:500;padding:2.5px 9px;border-radius:999px;background:#f4f4f5;color:var(--txt);border:1px solid var(--line);flex:none}
...
.rcitem{display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid var(--line);border-radius:12px;background:#fff;margin-bottom:8px;flex-wrap:wrap}
...
.ibaiout{margin-top:8px;font-size:12px;line-height:1.7;background:#f6f8fc;border:1px solid var(--line);border-radius:10px;padding:9px 11px;white-space:pre-wrap}
.mtbatch{white-space:nowrap}
.mtmask{position:fixed;inset:0;background:rgba(15,23,42,.5);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);z-index:120;display:none;align-items:center;justify-content:center;padding:20px}
.mtmask.open{display:flex}
.mtcard{background:#fff;border-radius:18px;max-width:560px;width:100%;padding:20px;box-shadow:0 24px 60px rgba(15,23,42,.25);animation:pop .18s ease}
.mtcard h3{margin:0 0 4px;font-size:16px;color:var(--txt)}
.mtcard .mthint{margin:0 0 10px;font-size:12px;color:var(--sub)}
.mtcard textarea{width:100%;min-height:180px;box-sizing:border-box;border:1px solid var(--line);border-radius:10px;padding:10px;font-family:inherit;font-size:13px;line-height:1.6;resize:vertical}
...
.schip{min-height:30px;padding:0 13px;border-radius:999px;border:1px solid var(--line);background:#fff;color:var(--sub);font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;transition:all .15s}
...
.dmg .dmtrack{flex:1;height:13px;border-radius:7px;background:#eef1f7;overflow:hidden}
.dmg .dmfill{height:100%;border-radius:7px;background:var(--grad);min-width:3px}
...
.ragsec .raginput input{flex:1;min-width:220px;min-height:36px;border:1px solid var(--line);border-radius:10px;padding:0 11px;font-family:inherit;font-size:13px;background:#fff;color:var(--txt);box-sizing:border-box}
.ragchips{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 10px}
.ragstat{font-size:12px;color:var(--sub);line-height:1.7}
.ragout{margin-top:9px;font-size:13px;line-height:1.85;background:#f6f8fc;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:var(--txt)}
.ragcite{display:inline-block;min-width:16px;padding:0 4px;margin:0 2px;border-radius:5px;background:var(--pri-soft);color:var(--pri);font-size:11px;font-weight:700;cursor:pointer;text-align:center;vertical-align:1px}
.ragcite:hover{filter:brightness(.94)}
.ragsrcs{margin-top:10px}
.ragsrc{border:1px solid var(--line);border-radius:10px;padding:8px 10px;margin-bottom:6px;font-size:12px;line-height:1.75;background:#fff}
...
/* ---------- 按钮 ---------- */
.btn{appearance:none;border:1px solid var(--line);cursor:pointer;padding:0 14px;height:34px;border-radius:7px;font-size:13px;font-weight:500;background:var(--card);color:var(--txt);font-family:inherit;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;min-height:34px;transition:background .15s,border-color .15s,transform .08s,filter .15s}
.btn:active{transform:translateY(1px)}
.btn:disabled{opacity:.5;cursor:not-allowed}
.btn-sm{height:30px;padding:0 11px;font-size:12px;min-height:30px;border-radius:6px}
.btn-pri{background:var(--grad);color:#fff;border-color:transparent;box-shadow:none}
.btn-pri:hover{filter:brightness(1.35)}
.btn-ghost{background:#fff;color:var(--pri);border:1px solid #c3e1fd}
.btn-ghost:hover{background:var(--pri-soft)}
.btn-go{background:var(--grad-green);color:#fff;border:1px solid var(--grad-green);box-shadow:none}
.btn-go:hover{filter:brightness(1.12)}
.btn-search{background:#fff;color:var(--sub);border:1px dashed #d4d4d4}
...
.btn-gray:hover{background:#f4f4f5;color:var(--txt)}
.btn-nav{background:#fff;color:var(--pri);border:1px solid var(--line);height:52px;padding:0 18px;font-size:14px;display:flex;align-items:center;gap:8px;text-decoration:none;border-radius:10px;transition:background .15s,border-color .15s}
.btn-nav:hover{background:#fafafa;border-color:#d4d4d4;box-shadow:none}
...
.chip{min-height:30px;padding:0 14px;border-radius:999px;border:1px solid var(--line);background:#fff;color:var(--sub);font-size:12px;font-weight:500;cursor:pointer;font-family:inherit;transition:all .15s}
.chip:hover{border-color:#d4d4d4;color:var(--txt)}
...
.agx{border:1px solid var(--line);border-radius:8px;padding:12px;margin-top:12px;background:#fff}
...
.agxf input[type="number"],.agxf input[type="text"],.agxf select{height:32px;font-size:12.5px;border:1px solid var(--line);border-radius:6px;padding:0 8px;font-family:inherit;background:#fff;color:var(--txt);width:100%}
.agxf input:focus,.agxf select:focus{outline:none;border-color:var(--pri);box-shadow:0 0 0 2px rgba(var(--pri-rgb),.12)}
.agxf textarea{font-size:12.5px;border:1px solid var(--line);border-radius:6px;padding:7px 9px;font-family:inherit;background:#fff;color:var(--txt);resize:vertical;width:100%;line-height:1.6}
...
.agxeff{font-family:var(--mono);font-size:11.5px;color:var(--sub);background:#fafafa;border:1px solid var(--line);border-radius:6px;padding:8px 10px;white-space:pre-wrap;line-height:1.75;margin-top:8px}
...
THEME_JS = """
/* ---------- 主题色自定义 ---------- */
var THEME_PRESETS=[['#0070f3','#0068d6','科技蓝(默认)'],['#171717','#383838','墨色'],['#1a7f37','#0f6e46','松石绿'],['#b45309','#92400e','琥珀橙'],['#c50000','#9f1239','绯红'],['#6d28d9','#4c2889','暮光紫'],['#334155','#64748b','石墨灰']];
